...
This game is a tile-based 2D adventure game created with Pygame. The video for this step can be found here [Load Different Areas - Adventure Game in Pygame 7](https://youtu.be/jnokXcEo-8g).
